...
O projeto foi configurado como Progressive Web App (PWA) com:

- `frontend/manifest.webmanifest` (metadados de instalação).
- `frontend/sw.js` (cache de shell da aplicação e suporte offline básico para rotas web).
- Ícones em `frontend/icons/`.

No primeiro acesso, o service worker é registrado automaticamente pelo frontend.
